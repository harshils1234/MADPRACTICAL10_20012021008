package com.example.madpractical10_20012021008

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.util.Log
import androidx.core.view.WindowCompat
import com.example.madpractical10_20012021008.databinding.ActivityMainBinding
            ...
            CoroutineScope(Dispatchers.IO).launch {
                try {
                    ...
                    val data = HttpRequest().makeServiceCall(
                        "https://api.json-generator.com/templates/odSuD9xtEtpK/data",
                        "dv5dn96wise6ejwceuortklxzzyhw6aoh6p94sdq")
